...
// Grouped "Conditions We Commonly Treat" list — an elegant grouped list
// rather than another wall of cards. Each entry links to the category page
// that covers it in more depth, where one exists.
export const commonConditionsGroups = [
  {
    heading: 'Attention, Anxiety & Stress',
    items: [
      { label: 'ADHD', path: '/conditions/adhd-executive-function' },
      { label: 'Anxiety Disorders', path: '/conditions/anxiety-stress-disorders' },
      { label: 'Panic Disorder', path: '/conditions/anxiety-stress-disorders' },
      { label: 'OCD', path: '/conditions/anxiety-stress-disorders' },
      { label: 'Health Anxiety', path: '/conditions/anxiety-stress-disorders' },
      { label: 'Somatic Symptom Disorders', path: '/conditions/anxiety-stress-disorders' },
      { label: 'Burnout', path: '/conditions/anxiety-stress-disorders' },
      { label: 'Stress-Related Disorders', path: '/conditions/anxiety-stress-disorders' },
      { label: 'Adjustment Disorders', path: '/conditions/anxiety-stress-disorders' },
    ],
  },
  {
    heading: 'Mood & Trauma',
    items: [
      { label: 'PTSD', path: '/conditions/trauma-life-transitions' },
      { label: 'Depression', path: '/conditions/depression-mood-disorders' },
      { label: 'Bipolar Disorder', path: '/conditions/depression-mood-disorders' },
      { label: 'Mood Disorders', path: '/conditions/depression-mood-disorders' },
    ],
  },
  {
    heading: 'Psychotic Disorders & Sleep',
    items: [
      { label: 'Schizophrenia', path: '/conditions/psychotic-disorders' },
      { label: 'Sleep Disorders', path: '/conditions/sleep-wellness' },
    ],
  },
  {
    heading: "Women's Mental Health",
    items: [
      { label: "Women's Mental Health", path: '/conditions/womens-mental-health' },
      { label: 'PMDD', path: '/conditions/womens-mental-health' },
      { label: 'Menopause', path: '/conditions/womens-mental-health' },
      { label: 'PCOS', path: '/conditions/womens-mental-health' },
      { label: 'Hormonal Mood Disorders', path: '/conditions/womens-mental-health' },
      { label: 'Pregnancy & Postpartum Mental Health', path: '/conditions/womens-mental-health' },
    ],
  },
  {
    heading: 'Memory & Cognitive Health',
    items: [
      { label: 'Dementia', path: '/conditions/memory-cognitive-health' },
      { label: 'Mild Cognitive Impairment', path: '/conditions/memory-cognitive-health' },
      { label: "Alzheimer's Disease", path: '/conditions/memory-cognitive-health' },
      { label: 'Memory Changes', path: '/conditions/memory-cognitive-health' },
      { label: 'Cognitive Disorders', path: '/conditions/memory-cognitive-health' },
    ],
  },
  {
    heading: 'Other Areas of Care',
    items: [
      { label: 'Eating Disorders', path: '/conditions/eating-disorders' },
      { label: 'LGBTQ+ Mental Health', path: '/conditions/lgbtq-mental-health' },
      { label: 'Thyroid & Diabetes Related Mood Disorders', path: '/conditions/medical-psychiatry' },
      { label: 'Impulse Control Disorders', path: '/conditions/behavioral-impulse-disorders' },
    ],
  },
];
