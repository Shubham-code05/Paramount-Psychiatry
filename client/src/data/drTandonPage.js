// Dr. Pooja Tandon physician profile — page content (Phase 3).
...
export const drHero = {
  ...
  heading: 'Meet Dr. Pooja Tandon, MD',
  subcopy: 'Healing begins with feeling heard.',
};
...
export const educationTraining = {
  ...
  heading: 'A foundation built across leading institutions.',
  timeline: [
    {
      icon: GraduationCap,
      title: 'Psychiatry Residency',
      institution: 'Creedmoor Psychiatric Center, New York',
    },
    {
      icon: BookOpenText,
      title: 'Extensive Clinical Training',
      institution: 'NewYork-Presbyterian / Columbia University Irving Medical Center',
    },
    {
      icon: GraduationCap,
      title: 'Advanced Fellowship, Geriatric Psychiatry',
      institution: 'Stony Brook University Medical Center',
    },
  ],
...
export const credentials = {
  ...
  boardCertification: {
    icon: ShieldCheck,
    label: 'Board Certified by the American Board of Psychiatry and Neurology',
  },
  research: {
    icon: BookOpenText,
    label:
...
export const drClosing = {
  icon: HeartPulse,
  heading: 'Committed to compassionate, personalized care.',
  body: 'Dr. Tandon is committed to compassionate, personalized psychiatric care — helping patients work toward emotional wellness and quality of life.',
  cta: 'Make an Appointment',
};

export const drTandonSeo = {
  title: 'Dr. Pooja Tandon, MD | Paramount Psychiatry',
  description:
    'Dr. Pooja Tandon, MD is a Board-Certified Adult and Geriatric Psychiatrist at Paramount Psychiatry, with clinical experience spanning academic medical centers, hospitals, and telepsychiatry.',
};
