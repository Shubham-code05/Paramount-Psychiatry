      ...
      >
        ...
        <ol className="grid grid-cols-1 gap-x-8 gap-y-8 sm:grid-cols-2 lg:grid-cols-5">
          {steps.map((step, index) => (
            <motion.li key={step.title} variants={fadeUp} className="flex flex-col gap-2 border-t-2 border-sage-deep/40 pt-4">
              <span className="text-caption font-semibold text-sage-deep" aria-hidden="true">
